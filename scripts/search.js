...
import { fetchEvents, getComponents } from "./utils.js"; // Import the getComponents function
getComponents();
...
fetchEvents();// Fetch events from JSON file and store in local storage if it's not already there
